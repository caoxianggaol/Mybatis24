...
<body>
    <div class="container">
        <form method="post" enctype="multipart/form-data">
            ...
            <div class="form-group">
                <label>商品市场价格</label>
                <input type="text" class="form-control" name="productMarketPice">
            </div>
            <div class="form-group">
                <label>商品库存数量</label>
            ...
            <div class="form-group">
                <label>商品详情</label>
                <textarea name="seckillDesc" id="editer" class="form-control"></textarea>
            </div>
            <div class="form-group">
                <button class="btn btn-lg btn-success">保存</button>
                <a href="/seckill/new" class="btn btn-lg btn-warning">取消</a>
            </div>
        </form>
    </div>
