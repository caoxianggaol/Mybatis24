    ...
    <div class="container">
        <div class="navbar-header">
            <a class="navbar-brand" href="/">
                <i class="fa fa-shopping-basket"></i> 返回
            </a>
        </div>
    </div>
</nav>
<div class="container">
    <div class="row">
        <div class="col-md-4">
            <img src="http://
ozptk4oqs.bkt.clouddn.com/${seckill.productImage}?imageView2/1/w/300/h/300" alt="">
        </div>
        <div class="col-md-8">
...
<script>
    $(function () {
        ...
        $("#secKillBtn").click(function () {
            $.get("/product/seckill/${seckill.id}").done(function (resp) {
