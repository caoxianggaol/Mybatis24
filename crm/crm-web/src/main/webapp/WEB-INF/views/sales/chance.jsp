        ...
        <section class="content">
            <div class="box">
                <div class="box-header with-border">
                    ...
                    <div class="box-tools">
                        <a href="/sales/smy" class="btn btn-primary btn-sm"><i class="fa fa-arrow-left"></i> 返回列表</a>
                ...
                <div class="modal-dialog">
                    <div class="modal-content">
                        ...
                        <div class="modal-body">
                            <form action="/sales/smy/snew/record" id="recordForm" method="post">
            ...
            <div class="modal fade" id="changeProgressModal">
                <div class="modal-dialog">
                    <div class="modal-content">
                        ...
                        <div class="modal-body">
                            <form method="post" action="/sales/smy/${saleChance.id}/progress/update" id="updateProgressForm">
    ...
    $(function () {
        ...
        $("#delBtn").click(function () {
            layer.confirm("确定要删除该机会吗?",function () {
                window.location.href = "/sales/smy/"+salesId+"/delete";
            });
        });
